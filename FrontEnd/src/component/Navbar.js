  ...
  //const dispatch = useDispatch();
        ...
        <>
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-warning mynav">
                <div className="container-fluid">
                    <a className="navbar-brand text-white" href="/"><i class="fa-solid fa-building-columns"></i>Digital Banking</a>
    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg navbar-light bg-warning mynav">
                <div className="container-fluid">
                    <a className="navbar-brand text-white" href="/"><i class="fa-solid fa-building-columns"></i>Digital Wallet</a>
                    <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        <span className="navbar-toggler-icon"></span>
                    </button>
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
